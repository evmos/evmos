...
func init() {
	...
	proto.RegisterType((*ClaimRecordAddress)(nil), "evmos.claims.v1.ClaimRecordAddress")
	proto.RegisterType((*ClaimRecord)(nil), "evmos.claims.v1.ClaimRecord")
}

func init() { proto.RegisterFile("evmos/claims/v1/claims.proto", fileDescriptor_873e678807803576) }
