...
func init() {
	proto.RegisterEnum("evoblock.claims.v1.Action", Action_name, Action_value)
	proto.RegisterType((*Claim)(nil), "evoblock.claims.v1.Claim")
	proto.RegisterType((*ClaimsRecordAddress)(nil), "evoblock.claims.v1.ClaimsRecordAddress")
	proto.RegisterType((*ClaimsRecord)(nil), "evoblock.claims.v1.ClaimsRecord")
}
