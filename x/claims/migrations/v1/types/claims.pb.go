...
func init() {
	proto.RegisterEnum("canto.claims.migration.v1.Action", Action_name, Action_value)
	proto.RegisterType((*Claim)(nil), "canto.claims.migration.v1.Claim")
	proto.RegisterType((*ClaimsRecordAddress)(nil), "canto.claims.migration.v1.ClaimsRecordAddress")
	proto.RegisterType((*ClaimsRecord)(nil), "canto.claims.migration.v1.ClaimsRecord")
}

func init() { proto.RegisterFile("canto/claims/v1/claims.proto", fileDescriptor_a7153f2307523893) }
