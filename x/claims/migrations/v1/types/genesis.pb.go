...
func init() {
	proto.RegisterType((*GenesisState)(nil), "canto.claims.migrations.v1.GenesisState")
	proto.RegisterType((*Params)(nil), "canto.claims.migrations.v1.Params")
}

func init() { proto.RegisterFile("canto/claims/v1/genesis.proto", fileDescriptor_f2f8f1d6f18af278) }
