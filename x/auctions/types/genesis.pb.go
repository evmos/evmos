...
type GenesisState struct {
	...
	// epochs is a slice of EpochInfo that defines the auction start time
	AuctionStartEpoch EpochInfo `protobuf:"bytes,2,opt,name=auction_start_epoch,json=auctionStartEpoch,proto3" json:"auction_start_epoch"`
	// epochs is a slice of EpochInfo that defines the auction end time
	AuctionEndEpoch EpochInfo `protobuf:"bytes,3,opt,name=auction_end_epoch,json=auctionEndEpoch,proto3" json:"auction_end_epoch"`
}
...
func (m *GenesisState) GetAuctionStartEpoch() EpochInfo {
	if m != nil {
		return m.AuctionStartEpoch
	}
	return EpochInfo{}
}

func (m *GenesisState) GetAuctionEndEpoch() EpochInfo {
	if m != nil {
		return m.AuctionEndEpoch
	}
	return EpochInfo{}
}
...
var fileDescriptor_06e64ba959c4dda5 = []byte{
	...
	,
}
...
func (m *GenesisState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size, err := m.AuctionEndEpoch.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	dAtA[i] = 0x1a
	{
		size, err := m.AuctionStartEpoch.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *EpochInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	n4, err4 := github_com_cosmos_gogoproto_types.StdTimeMarshalTo(m.CurrentEpochStartTime, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdTime(m.CurrentEpochStartTime):])
	if err4 != nil {
		return 0, err4
	}
	i -= n4
...
func (m *GenesisState) Size() (n int) {
	...
	l = m.AuctionStartEpoch.Size()
	n += 1 + l + sovGenesis(uint64(l))
	l = m.AuctionEndEpoch.Size()
	n += 1 + l + sovGenesis(uint64(l))
	return n
}
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AuctionStartEpoch", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.AuctionStartEpoch.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AuctionEndEpoch", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.AuctionEndEpoch.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
