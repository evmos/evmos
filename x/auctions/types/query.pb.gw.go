...
func request_Query_AuctionInfo_0(ctx context.Context, marshaler runtime.Marshaler, client QueryClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq QueryCurrentAuctionInfoRequest
...
var (
	pattern_Query_AuctionInfo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"evmos", "auctions", "v1", "auction_info"}, "", runtime.AssumeColonVerbOpt(false)))
