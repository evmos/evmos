...
func NewTxCmd() *cobra.Command {
	...
	txCmd.AddCommand(
		...
		NewMsgOptInGovernanceClawbackCmd(),
	)
...
// NewMsgOptInGovernanceClawbackCmd returns a CLI command handler for creating a
// MsgOptInGovernanceClawback transaction.
func NewMsgOptInGovernanceClawbackCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			msg := types.NewMsgOptInGovernanceClawback(addr)
			if err := msg.ValidateBasic(); err != nil {
				return err
			}
