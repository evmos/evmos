...
This document specifies the internal `x/vesting` module of the Evoblock Hub.
...
For Evoblock, the `ClawbackVestingAccount` is used to allocate tokens to core team members and advisors to incentivize long-term participation in the project.
