...
// source: evoblock/vesting/v1/query.proto
...
func init() {
	proto.RegisterType((*QueryBalancesRequest)(nil), "evoblock.vesting.v1.QueryBalancesRequest")
	proto.RegisterType((*QueryBalancesResponse)(nil), "evoblock.vesting.v1.QueryBalancesResponse")
}

func init() { proto.RegisterFile("evoblock/vesting/v1/query.proto", fileDescriptor_ff0457b141ab5d28) }
...
func (c *queryClient) Balances(ctx context.Context, in *QueryBalancesRequest, opts ...grpc.CallOption) (*QueryBalancesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/evoblock.vesting.v1.Query/Balances", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Balances_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/evoblock.vesting.v1.Query/Balances",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "evoblock.vesting.v1.Query",
	...
	Metadata: "evoblock/vesting/v1/query.proto",
}
