...
// MsgGovClawback defines a message that removes unvested tokens from a
// ClawbackVestingAccount through a governance proposal.
type MsgGovClawback struct {
...
func (m *MsgGovClawback) Reset()         { *m = MsgGovClawback{} }
func (m *MsgGovClawback) String() string { return proto.CompactTextString(m) }
func (*MsgGovClawback) ProtoMessage()    {}
func (*MsgGovClawback) Descriptor() ([]byte, []int) {
	return fileDescriptor_d5db113bc0c7240c, []int{3}
}
func (m *MsgGovClawback) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgGovClawback) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgGovClawback.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgGovClawback) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgGovClawback.Merge(m, src)
}
func (m *MsgGovClawback) XXX_Size() int {
	return m.Size()
}
func (m *MsgGovClawback) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgGovClawback.DiscardUnknown(m)
}

var xxx_messageInfo_MsgGovClawback proto.InternalMessageInfo

func (m *MsgGovClawback) GetAuthority() string {
	if m != nil {
		return m.Authority
	}
	return ""
...
func (m *MsgGovClawback) GetAccountAddress() string {
	if m != nil {
		return m.AccountAddress
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*MsgGovClawback)(nil), "evmos.vesting.v1.MsgGovClawback")
...
var fileDescriptor_d5db113bc0c7240c = []byte{
	...
	,
}
...
type MsgClient interface {
	...
	// GovernanceClawback removes the unvested tokens from a ClawbackVestingAccount by governance proposal.
	GovernanceClawback(ctx context.Context, in *MsgGovClawback, opts ...grpc.CallOption) (*MsgClawbackResponse, error)
...
func (c *msgClient) GovernanceClawback(ctx context.Context, in *MsgGovClawback, opts ...grpc.CallOption) (*MsgClawbackResponse, error) {
	out := new(MsgClawbackResponse)
	err := c.cc.Invoke(ctx, "/evmos.vesting.v1.Msg/GovernanceClawback", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MsgServer interface {
	...
	// GovernanceClawback removes the unvested tokens from a ClawbackVestingAccount by governance proposal.
	GovernanceClawback(context.Context, *MsgGovClawback) (*MsgClawbackResponse, error)
	// UpdateVestingFunder updates the funder address of an existing
	// ClawbackVestingAccount.
...
func (*UnimplementedMsgServer) GovernanceClawback(ctx context.Context, req *MsgGovClawback) (*MsgClawbackResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GovernanceClawback not implemented")
}
...
func _Msg_GovernanceClawback_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MsgGovClawback)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgServer).GovernanceClawback(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/evmos.vesting.v1.Msg/GovernanceClawback",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).GovernanceClawback(ctx, req.(*MsgGovClawback))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GovernanceClawback",
			Handler:    _Msg_GovernanceClawback_Handler,
		},
		{
...
func (m *MsgGovClawback) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgGovClawback) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgGovClawback) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgGovClawback) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgGovClawback) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgGovClawback: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgGovClawback: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
