...
func init() {
	proto.RegisterType((*EventCreateClawbackVestingAccount)(nil), "eidon-chain.vesting.v2.EventCreateClawbackVestingAccount")
	proto.RegisterType((*EventFundVestingAccount)(nil), "eidon-chain.vesting.v2.EventFundVestingAccount")
	proto.RegisterType((*EventClawback)(nil), "eidon-chain.vesting.v2.EventClawback")
	proto.RegisterType((*EventUpdateVestingFunder)(nil), "eidon-chain.vesting.v2.EventUpdateVestingFunder")
}

func init() { proto.RegisterFile("eidon-chain/vesting/v2/events.proto", fileDescriptor_7a6fa6478193a613) }
