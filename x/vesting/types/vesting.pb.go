...
func init() {
	proto.RegisterType((*ClawbackVestingAccount)(nil), "eidon-chain.vesting.v2.ClawbackVestingAccount")
	proto.RegisterType((*ClawbackProposal)(nil), "eidon-chain.vesting.v2.ClawbackProposal")
}

func init() { proto.RegisterFile("eidon-chain/vesting/v2/vesting.proto", fileDescriptor_0001d894a8ee0c72) }
