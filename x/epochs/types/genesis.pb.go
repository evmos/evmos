...
func init() {
	proto.RegisterType((*EpochInfo)(nil), "eidon-chain.epochs.v1.EpochInfo")
	proto.RegisterType((*GenesisState)(nil), "eidon-chain.epochs.v1.GenesisState")
}

func init() { proto.RegisterFile("eidon-chain/epochs/v1/genesis.proto", fileDescriptor_c74bc0b3e7fa01c2) }
