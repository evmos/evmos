...
type ClaimRecord struct {
	...
	InitialClaimableAmount github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,2,rep,name=initial_claimable_amount,json=initialClaimableAmount,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.Coins" json:"initial_claimable_amount"`
	// slice of the available actions (enums) completed
	ActionsCompleted []Action `protobuf:"varint,3,rep,packed,name=actions_completed,json=actionsCompleted,proto3,enum=evmos.claim.v1.Action" json:"actions_completed,omitempty"`
}
...
func (m *ClaimRecord) GetActionsCompleted() []Action {
	if m != nil {
...
var fileDescriptor_873e678807803576 = []byte{
	...
	,
}
...
func (m *ClaimRecord) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ActionsCompleted) > 0 {
		dAtA2 := make([]byte, len(m.ActionsCompleted)*10)
		var j1 int
		for _, num := range m.ActionsCompleted {
			for num >= 1<<7 {
...
func (m *ClaimRecord) Size() (n int) {
	...
	if len(m.ActionsCompleted) > 0 {
		l = 0
		for _, e := range m.ActionsCompleted {
			l += sovClaim(uint64(e))
		}
	...
	for iNdEx < l {
		...
		case 3:
			if wireType == 0 {
				...
				m.ActionsCompleted = append(m.ActionsCompleted, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				if elementCount != 0 && len(m.ActionsCompleted) == 0 {
					m.ActionsCompleted = make([]Action, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v Action
					for shift := uint(0); ; shift += 7 {
