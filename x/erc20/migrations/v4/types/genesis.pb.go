...
type GenesisState struct {
	...
	Params V4Params `protobuf:"bytes,1,opt,name=params,proto3" json:"params"`
	// token_pairs is a slice of the registered token pairs at genesis
	TokenPairs []v4TokenPair `protobuf:"bytes,2,rep,name=token_pairs,json=tokenPairs,proto3" json:"token_pairs"`
}
...
func (m *GenesisState) GetParams() V4Params {
	if m != nil {
		return m.Params
	}
	return V4Params{}
...
func (m *GenesisState) GetTokenPairs() []v4TokenPair {
	if m != nil {
		return m.TokenPairs
	}
	return nil
...
// V4Params defines the erc20 module params
...
func (m *V4Params) GetEnableErc20() bool {
	if m != nil {
...
func (m *V4Params) GetEnableEVMHook() bool {
	if m != nil {
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "evmos.erc20.v1.V4GenesisState")
	proto.RegisterType((*V4Params)(nil), "evmos.erc20.v1.V4Params")
}
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.TokenPairs = append(m.TokenPairs, v4TokenPair{})
