...
// v4Owner enumerates the ownership of a ERC20 contract.
type v4Owner int32

const (
	// OWNER_UNSPECIFIED defines an invalid/undefined owner.
	OWNER_UNSPECIFIED v4Owner = 0
	// OWNER_MODULE - erc20 is owned by the erc20 module account.
	OWNER_MODULE v4Owner = 1
	// OWNER_EXTERNAL - erc20 is owned by an external account.
	OWNER_EXTERNAL v4Owner = 2
)
...
func (x v4Owner) String() string {
	return proto.EnumName(Owner_name, int32(x))
}

func (v4Owner) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_668d5dc537f45142, []int{0}
}

// v4TokenPair defines an instance that records a pairing consisting of a native
// Cosmos Coin and an ERC20 token address.
type v4TokenPair struct {
	...
	ContractOwner v4Owner `protobuf:"varint,4,opt,name=contract_owner,json=contractOwner,proto3,enum=evmos.erc20.v1.Owner" json:"contract_owner,omitempty"`
}

func (m *v4TokenPair) Reset()         { *m = v4TokenPair{} }
func (m *v4TokenPair) String() string { return proto.CompactTextString(m) }
func (*v4TokenPair) ProtoMessage()    {}
func (*v4TokenPair) Descriptor() ([]byte, []int) {
	return fileDescriptor_668d5dc537f45142, []int{0}
}
func (m *v4TokenPair) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *v4TokenPair) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
...
func (m *v4TokenPair) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TokenPair.Merge(m, src)
}
func (m *v4TokenPair) XXX_Size() int {
	return m.Size()
}
func (m *v4TokenPair) XXX_DiscardUnknown() {
	xxx_messageInfo_TokenPair.DiscardUnknown(m)
}

var xxx_messageInfo_TokenPair proto.InternalMessageInfo

func (m *v4TokenPair) GetErc20Address() string {
	if m != nil {
...
func (m *v4TokenPair) GetDenom() string {
	if m != nil {
		return m.Denom
	}
	return ""
...
func (m *v4TokenPair) GetEnabled() bool {
	if m != nil {
		return m.Enabled
	}
	return false
...
func (m *v4TokenPair) GetContractOwner() v4Owner {
	if m != nil {
...
func init() {
	proto.RegisterEnum("evmos.erc20.v1.V4Owner", Owner_name, Owner_value)
	proto.RegisterType((*v4TokenPair)(nil), "evmos.erc20.v1.V4TokenPair")
	proto.RegisterType((*RegisterCoinProposal)(nil), "evmos.erc20.v1.V4RegisterCoinProposal")
	proto.RegisterType((*ProposalMetadata)(nil), "evmos.erc20.v1.V4ProposalMetadata")
	proto.RegisterType((*RegisterERC20Proposal)(nil), "evmos.erc20.v1.V4RegisterERC20Proposal")
	proto.RegisterType((*ToggleTokenConversionProposal)(nil), "evmos.erc20.v1.V4ToggleTokenConversionProposal")
}
...
func (this *v4TokenPair) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*v4TokenPair)
	if !ok {
		that2, ok := that.(v4TokenPair)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (m *v4TokenPair) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
...
func (m *v4TokenPair) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *v4TokenPair) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *v4TokenPair) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ContractOwner |= v4Owner(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
