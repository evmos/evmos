...
const (
	...
	// OWNER_EXTERNAL - erc20 is owned by an external owned account.
...
// V5TokenPair defines an instance that records a pairing consisting of a native
// Cosmos Coin and an ERC20 token address.
type V5TokenPair struct {
...
func (m *V5TokenPair) Reset()         { *m = V5TokenPair{} }
func (m *V5TokenPair) String() string { return proto.CompactTextString(m) }
func (*V5TokenPair) ProtoMessage()    {}
func (*V5TokenPair) Descriptor() ([]byte, []int) {
	return fileDescriptor_668d5dc537f45142, []int{0}
}

func (m *V5TokenPair) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}

func (m *V5TokenPair) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
...
func (m *V5TokenPair) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TokenPair.Merge(m, src)
}

func (m *V5TokenPair) XXX_Size() int {
	return m.Size()
}

func (m *V5TokenPair) XXX_DiscardUnknown() {
	xxx_messageInfo_TokenPair.DiscardUnknown(m)
}

var xxx_messageInfo_TokenPair proto.InternalMessageInfo

func (m *V5TokenPair) GetErc20Address() string {
	if m != nil {
...
func (m *V5TokenPair) GetDenom() string {
	if m != nil {
		return m.Denom
	}
	return ""
...
func (m *V5TokenPair) GetEnabled() bool {
	if m != nil {
		return m.Enabled
	}
	return false
...
func (m *V5TokenPair) GetContractOwner() Owner {
	if m != nil {
...
func (this *V5TokenPair) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*V5TokenPair)
	if !ok {
		that2, ok := that.(V5TokenPair)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (m *V5TokenPair) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
...
func (m *V5TokenPair) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *V5TokenPair) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *V5TokenPair) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
