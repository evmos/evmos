...
func init() {
	proto.RegisterType((*V3GenesisState)(nil), "eidon-chain.erc20.v1.V3GenesisState")
	proto.RegisterType((*V3Params)(nil), "eidon-chain.erc20.v1.V3Params")
}

func init() { proto.RegisterFile("eidon-chain/erc20/v1/genesis.proto", fileDescriptor_2f4674601b0d6987) }
