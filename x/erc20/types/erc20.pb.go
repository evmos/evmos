...
// UpdateERC20MetadataProposal is a gov Content type
// it updates the bank metadata in case of incorrect automatic generation
type UpdateERC20MetadataProposal struct {
	// title of the proposal
	Title string `protobuf:"bytes,1,opt,name=title,proto3" json:"title,omitempty"`
	// description of the proposal
	Description string `protobuf:"bytes,2,opt,name=description,proto3" json:"description,omitempty"`
	// address of the erc20 extension contract
	...
	// supported options are 6 (micro), 9 (nano) and 18 (atto).
	Decimals uint32 `protobuf:"varint,6,opt,name=decimals,proto3" json:"decimals,omitempty"`
}

func (m *UpdateERC20MetadataProposal) Reset()         { *m = UpdateERC20MetadataProposal{} }
func (m *UpdateERC20MetadataProposal) String() string { return proto.CompactTextString(m) }
func (*UpdateERC20MetadataProposal) ProtoMessage()    {}
func (*UpdateERC20MetadataProposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_668d5dc537f45142, []int{5}
}
func (m *UpdateERC20MetadataProposal) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *UpdateERC20MetadataProposal) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_UpdateERC20MetadataProposal.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *UpdateERC20MetadataProposal) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UpdateERC20MetadataProposal.Merge(m, src)
}
func (m *UpdateERC20MetadataProposal) XXX_Size() int {
	return m.Size()
}
func (m *UpdateERC20MetadataProposal) XXX_DiscardUnknown() {
	xxx_messageInfo_UpdateERC20MetadataProposal.DiscardUnknown(m)
}

var xxx_messageInfo_UpdateERC20MetadataProposal proto.InternalMessageInfo

func (m *UpdateERC20MetadataProposal) GetTitle() string {
	if m != nil {
		return m.Title
	}
	return ""
...
func (m *UpdateERC20MetadataProposal) GetDescription() string {
	if m != nil {
		return m.Description
	}
	return ""
...
func (m *UpdateERC20MetadataProposal) GetContract() string {
	if m != nil {
		return m.Contract
	}
	return ""
...
func (m *UpdateERC20MetadataProposal) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *UpdateERC20MetadataProposal) GetSymbol() string {
	if m != nil {
		return m.Symbol
	}
	return ""
...
func (m *UpdateERC20MetadataProposal) GetDecimals() uint32 {
	if m != nil {
		return m.Decimals
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*UpdateERC20MetadataProposal)(nil), "evmos.erc20.v1.UpdateERC20MetadataProposal")
}
...
var fileDescriptor_668d5dc537f45142 = []byte{
	...
	,
}
...
func (m *UpdateERC20MetadataProposal) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *UpdateERC20MetadataProposal) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *UpdateERC20MetadataProposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.Contract) > 0 {
		...
		i = encodeVarintErc20(dAtA, i, uint64(len(m.Contract)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Description) > 0 {
...
func (m *UpdateERC20MetadataProposal) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *UpdateERC20MetadataProposal) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: UpdateERC20MetadataProposal: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: UpdateERC20MetadataProposal: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
