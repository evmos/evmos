...
func init() {
	proto.RegisterEnum("eidon-chain.erc20.v1.Owner", Owner_name, Owner_value)
	proto.RegisterType((*TokenPair)(nil), "eidon-chain.erc20.v1.TokenPair")
	proto.RegisterType((*RegisterCoinProposal)(nil), "eidon-chain.erc20.v1.RegisterCoinProposal")
	proto.RegisterType((*ProposalMetadata)(nil), "eidon-chain.erc20.v1.ProposalMetadata")
	proto.RegisterType((*RegisterERC20Proposal)(nil), "eidon-chain.erc20.v1.RegisterERC20Proposal")
	proto.RegisterType((*ToggleTokenConversionProposal)(nil), "eidon-chain.erc20.v1.ToggleTokenConversionProposal")
}

func init() { proto.RegisterFile("eidon-chain/erc20/v1/erc20.proto", fileDescriptor_668d5dc537f45142) }
