...
func (m *EventRegisterCoin) Reset()         { *m = EventRegisterCoin{} }
func (m *EventRegisterCoin) String() string { return proto.CompactTextString(m) }
func (*EventRegisterCoin) ProtoMessage()    {}
func (*EventRegisterCoin) Descriptor() ([]byte, []int) {
	return fileDescriptor_b8091384ab031e64, []int{0}
}
func (m *EventRegisterCoin) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EventRegisterCoin) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EventRegisterCoin.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
...
func (m *EventRegisterCoin) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EventRegisterCoin.Merge(m, src)
}
func (m *EventRegisterCoin) XXX_Size() int {
	return m.Size()
}
func (m *EventRegisterCoin) XXX_DiscardUnknown() {
	xxx_messageInfo_EventRegisterCoin.DiscardUnknown(m)
}

var xxx_messageInfo_EventRegisterCoin proto.InternalMessageInfo

func (m *EventRegisterCoin) GetDenom() string {
	if m != nil {
		return m.Denom
	}
	return ""
...
func (m *EventRegisterCoin) GetErc20Address() string {
	if m != nil {
...
func init() {
	proto.RegisterType((*EventRegisterCoin)(nil), "evmos.erc20.v1.EventRegisterCoin")
...
var fileDescriptor_b8091384ab031e64 = []byte{
	...
	,
}

func (m *EventRegisterCoin) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
...
func (m *EventRegisterCoin) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EventRegisterCoin) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *EventRegisterCoin) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EventRegisterCoin) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		if wireType == 4 {
			return fmt.Errorf("proto: EventRegisterCoin: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EventRegisterCoin: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
