...
func (suite *ProposalTestSuite) TestRegisterERC20Proposal() {
	testCases := []struct {
		...
		// Valid tests
		{msg: "Register token pair - valid pair enabled", title: "test", description: "test desc", pair: TokenPair{testutil.GenerateAddress().String(), "test", true, OWNER_MODULE}, expectPass: true},
		{msg: "Register token pair - valid pair dissabled", title: "test", description: "test desc", pair: TokenPair{testutil.GenerateAddress().String(), "test", false, OWNER_MODULE}, expectPass: true},
		// Missing params valid
		{msg: "Register token pair - invalid missing title ", title: "", description: "test desc", pair: TokenPair{testutil.GenerateAddress().String(), "test", false, OWNER_MODULE}, expectPass: false},
		{msg: "Register token pair - invalid missing description ", title: "test", description: "", pair: TokenPair{testutil.GenerateAddress().String(), "test", false, OWNER_MODULE}, expectPass: false},
		// Invalid address
