...
// IsAvailablePrecompile provides a mock function with given fields: ctx, addr
func (_m *EVMKeeper) IsAvailablePrecompile(ctx types.Context, addr common.Address) bool {
	ret := _m.Called(ctx, addr)
