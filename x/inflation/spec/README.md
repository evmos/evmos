...
The `x/inflation` module mints new Evoblock tokens and allocates them in daily
epochs according to the [Evoblock Token
Model](https://evoblock.blog/the-evoblock-token-model-edc07014978b) distribution to
...
The allocation of new coins incentivizes specific behaviour in the Evoblock
