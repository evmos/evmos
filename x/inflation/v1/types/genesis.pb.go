...
func init() {
	proto.RegisterType((*GenesisState)(nil), "eidon-chain.inflation.v1.GenesisState")
	proto.RegisterType((*Params)(nil), "eidon-chain.inflation.v1.Params")
}

func init() { proto.RegisterFile("eidon-chain/inflation/v1/genesis.proto", fileDescriptor_1cb8eee530db1235) }
