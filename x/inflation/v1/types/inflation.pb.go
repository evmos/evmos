...
func init() {
	proto.RegisterType((*InflationDistribution)(nil), "eidon-chain.inflation.v1.InflationDistribution")
	proto.RegisterType((*ExponentialCalculation)(nil), "eidon-chain.inflation.v1.ExponentialCalculation")
}

func init() {
	proto.RegisterFile("eidon-chain/inflation/v1/inflation.proto", fileDescriptor_d064cb35c3ff7df8)
}
