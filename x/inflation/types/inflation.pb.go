...
// source: evoblock/inflation/v1/inflation.proto
...
func init() {
	proto.RegisterType((*InflationDistribution)(nil), "evoblock.inflation.v1.InflationDistribution")
	proto.RegisterType((*ExponentialCalculation)(nil), "evoblock.inflation.v1.ExponentialCalculation")
}

func init() {
	proto.RegisterFile("evoblock/inflation/v1/inflation.proto", fileDescriptor_d064cb35c3ff7df8)
}
