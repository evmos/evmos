...
type AllocationMeter struct {
	// denoms and percentage of total allocations
	Allocation types.DecCoin `protobuf:"bytes,1,opt,name=allocation,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.DecCoins" json:"allocation"`
}

func (m *AllocationMeter) Reset()         { *m = AllocationMeter{} }
func (m *AllocationMeter) String() string { return proto.CompactTextString(m) }
func (*AllocationMeter) ProtoMessage()    {}
func (*AllocationMeter) Descriptor() ([]byte, []int) {
	return fileDescriptor_95b81e40854aec77, []int{2}
}
func (m *AllocationMeter) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AllocationMeter) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AllocationMeter.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AllocationMeter) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AllocationMeter.Merge(m, src)
}
func (m *AllocationMeter) XXX_Size() int {
	return m.Size()
}
func (m *AllocationMeter) XXX_DiscardUnknown() {
	xxx_messageInfo_AllocationMeter.DiscardUnknown(m)
}

var xxx_messageInfo_AllocationMeter proto.InternalMessageInfo

func (m *AllocationMeter) GetAllocation() types.DecCoin {
	if m != nil {
		return m.Allocation
	}
...
func (*CancelIncentiveProposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_95b81e40854aec77, []int{4}
}
...
func init() {
	...
	proto.RegisterType((*AllocationMeter)(nil), "evmos.incentives.v1.AllocationMeter")
...
var fileDescriptor_95b81e40854aec77 = []byte{
	...
	,
}
...
func (m *AllocationMeter) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AllocationMeter) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AllocationMeter) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *AllocationMeter) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *AllocationMeter) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AllocationMeter: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AllocationMeter: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
