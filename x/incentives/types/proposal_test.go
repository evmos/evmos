	...
	testCases := []struct {
	...
	}{
		{
			...
			Incentive{
				...
				sdk.DecCoins{sdk.NewDecCoinFromDec("abera", sdk.NewDecWithPrec(5, 2))},
				10,
				time.Now(),
				0,
			},
		...
		},
		{
			...
			Incentive{
				tests.GenerateAddress().String(),
				sdk.DecCoins{sdk.NewDecCoinFromDec("abera", sdk.NewDecWithPrec(101, 2))},
				10,
				time.Now(),
				0,
			},
		...
		},
		{
			...
			Incentive{
				tests.GenerateAddress().String(),
				sdk.DecCoins{sdk.NewDecCoinFromDec("abera", sdk.NewDecWithPrec(0, 2))},
				10,
				time.Now(),
				0,
			},
