...
The `x/incentive` module allows for two types of registration state transitions:  `RegisterIncentiveProposal` and `CancelIncentiveProposal`. Further logic (e.g. logging of gas used and distribution of rewards) is handled through [Hooks](05_hooks.md).
