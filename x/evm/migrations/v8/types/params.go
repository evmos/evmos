...
var (
	...
	DefaultAccessControl            = V7AccessControl{
		Create: V7AccessControlType{
			AccessType:        AccessTypePermissionless,
			AccessControlList: DefaultCreateAllowlistAddresses,
		},
		Call: V7AccessControlType{
			AccessType:        AccessTypePermissionless,
			AccessControlList: DefaultCreateAllowlistAddresses,
		},
	}
...
func NewParams(
	...
	config V7ChainConfig,
	extraEIPs []int64,
	activePrecompiles,
	evmChannels []string,
	accessControl V7AccessControl,
) V7Params {
	return V7Params{
		EvmDenom:            evmDenom,
...
func (p V7Params) Validate() error {
...
func (p V7Params) HasCustomPrecompiles() bool {
...
func (p V7Params) GetActivePrecompilesAddrs() []common.Address {
...
// EVM channels
func (p V7Params) IsEVMChannel(channel string) bool {
...
func (p V7Params) IsActivePrecompile(address string) bool {
...
func (ac V7AccessControl) Validate() error {
...
func (act V7AccessControlType) Validate() error {
