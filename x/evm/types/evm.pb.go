...
var AccessType_name = map[int32]string{
	0: "ACCESS_TYPE_EVERYBODY",
	1: "ACCESS_TYPE_NOBODY",
	2: "ACCESS_TYPE_WHITELIST_ADDRESSES",
}

var AccessType_value = map[string]int32{
	"ACCESS_TYPE_EVERYBODY":           0,
	"ACCESS_TYPE_NOBODY":              1,
	"ACCESS_TYPE_WHITELIST_ADDRESSES": 2,
}
...
type Params struct {
	...
	PermissionsPolicy *Permissions `protobuf:"bytes,9,opt,name=permissions,proto3" json:"permissions,omitempty"`
}
...
func (m *Params) GetPermissionsPolicy() *Permissions {
	if m != nil {
		return m.PermissionsPolicy
	}
	return nil
}
...
type Permissions struct {
	...
	Create *PermissionType `protobuf:"bytes,1,opt,name=create,proto3" json:"create,omitempty"`
	// call defines the permission policy for calling contracts
	Call *PermissionType `protobuf:"bytes,2,opt,name=call,proto3" json:"call,omitempty"`
}
...
func (m *Permissions) GetCreate() *PermissionType {
	if m != nil {
		return m.Create
	}
	return nil
...
func (m *Permissions) GetCall() *PermissionType {
	if m != nil {
		return m.Call
	}
	return nil
...
type PermissionType struct {
	AccessTypes      AccessType `protobuf:"varint,1,opt,name=access_type,json=accessType,proto3,enum=ethermint.evm.v1.AccessType" json:"access_type,omitempty" yaml:"access_types"`
	WhitelistAddress []string   `protobuf:"bytes,2,rep,name=whitelist_addresses,json=whitelistAddresses,proto3" json:"whitelist_addresses,omitempty" yaml:"whitelist_addresses"`
}

func (m *PermissionType) Reset()         { *m = PermissionType{} }
func (m *PermissionType) String() string { return proto.CompactTextString(m) }
func (*PermissionType) ProtoMessage()    {}
func (*PermissionType) Descriptor() ([]byte, []int) {
	return fileDescriptor_d21ecc92c8c8583e, []int{2}
}
func (m *PermissionType) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *PermissionType) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_PermissionType.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *PermissionType) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PermissionType.Merge(m, src)
}
func (m *PermissionType) XXX_Size() int {
	return m.Size()
}
func (m *PermissionType) XXX_DiscardUnknown() {
	xxx_messageInfo_PermissionType.DiscardUnknown(m)
}

var xxx_messageInfo_PermissionType proto.InternalMessageInfo

func (m *PermissionType) GetAccessTypes() AccessType {
	if m != nil {
...
func (m *PermissionType) GetWhitelistAddress() []string {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*Permissions)(nil), "ethermint.evm.v1.Permissions")
	proto.RegisterType((*PermissionType)(nil), "ethermint.evm.v1.PermissionType")
...
var fileDescriptor_d21ecc92c8c8583e = []byte{
	...
	,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.PermissionsPolicy != nil {
		{
			size, err := m.PermissionsPolicy.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *PermissionType) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *PermissionType) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PermissionType) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.WhitelistAddress) > 0 {
		for iNdEx := len(m.WhitelistAddress) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintEvm(dAtA, i, uint64(len(m.WhitelistAddress[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
	if m.AccessTypes != 0 {
		i = encodeVarintEvm(dAtA, i, uint64(m.AccessTypes))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *PermissionType) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.AccessTypes != 0 {
		n += 1 + sovEvm(uint64(m.AccessTypes))
	}
	if len(m.WhitelistAddress) > 0 {
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			...
			if m.PermissionsPolicy == nil {
				m.PermissionsPolicy = &Permissions{}
			}
			if err := m.PermissionsPolicy.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *PermissionType) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PermissionType: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PermissionType: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field AccessTypes", wireType)
			}
			m.AccessTypes = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.AccessTypes |= AccessType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
