...
const (
	// CREATE is the opcode for creating a new contract
	CREATE OpCode = 0
	// CREATE2 is the opcode for creating a new contract with a specific hash
	CREATE2 OpCode = 1
)
...
type Params struct {
	...
	// CustomOpcodes is the list of opcodes to update
	CustomOpCodes []CustomOpCode `protobuf:"bytes,10,rep,name=custom_opcodes,json=customOpcodes,proto3" json:"custom_opcodes"`
}
...
func (m *Params) GetCustomOpCodes() []CustomOpCode {
	if m != nil {
		return m.CustomOpCodes
	}
	return nil
}

type CustomOpCode struct {
	// opcode is the opcode to update
	OpCode OpCode `protobuf:"varint,1,opt,name=op_code,json=opCode,proto3,enum=ethermint.evm.v1.OpCode" json:"op_code,omitempty"`
	// consume_gas is the amount of gas to consume for the opcode
	ConstantGas uint64 `protobuf:"varint,2,opt,name=constant_gas,json=constantGas,proto3" json:"constant_gas,omitempty"`
}

func (m *CustomOpCode) Reset()         { *m = CustomOpCode{} }
func (m *CustomOpCode) String() string { return proto.CompactTextString(m) }
func (*CustomOpCode) ProtoMessage()    {}
func (*CustomOpCode) Descriptor() ([]byte, []int) {
	return fileDescriptor_d21ecc92c8c8583e, []int{1}
}
func (m *CustomOpCode) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CustomOpCode) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CustomOpCode.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CustomOpCode) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CustomOpCode.Merge(m, src)
}
func (m *CustomOpCode) XXX_Size() int {
	return m.Size()
}
func (m *CustomOpCode) XXX_DiscardUnknown() {
	xxx_messageInfo_CustomOpCode.DiscardUnknown(m)
}

var xxx_messageInfo_CustomOpCode proto.InternalMessageInfo

func (m *CustomOpCode) GetOpCode() OpCode {
	if m != nil {
		return m.OpCode
	}
	return CREATE
...
func (m *CustomOpCode) GetConstantGas() uint64 {
	if m != nil {
		return m.ConstantGas
	}
	return 0
}
...
func init() {
	proto.RegisterEnum("ethermint.evm.v1.OpCode", OpCode_name, OpCode_value)
	...
	proto.RegisterType((*CustomOpCode)(nil), "ethermint.evm.v1.CustomOpCode")
...
var fileDescriptor_d21ecc92c8c8583e = []byte{
	...
	,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.CustomOpCodes) > 0 {
		for iNdEx := len(m.CustomOpCodes) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.CustomOpCodes[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *CustomOpCode) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CustomOpCode) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CustomOpCode) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.ConstantGas != 0 {
		i = encodeVarintEvm(dAtA, i, uint64(m.ConstantGas))
		i--
		dAtA[i] = 0x10
	}
	if m.OpCode != 0 {
		i = encodeVarintEvm(dAtA, i, uint64(m.OpCode))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *CustomOpCode) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.OpCode != 0 {
		n += 1 + sovEvm(uint64(m.OpCode))
	}
	if m.ConstantGas != 0 {
		n += 1 + sovEvm(uint64(m.ConstantGas))
	}
	return n
}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CustomOpCodes", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CustomOpCodes = append(m.CustomOpCodes, CustomOpCode{})
			if err := m.CustomOpCodes[len(m.CustomOpCodes)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *CustomOpCode) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CustomOpCode: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CustomOpCode: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ConstantGas", wireType)
			}
			m.ConstantGas = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ConstantGas |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
