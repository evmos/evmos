...
type Params struct {
	...
	// wrapped_native_coin_precompiles defines the slice of hex addresses of the
	// wrapped native coins represented as precompiles
	WrappedNativeCoinPrecompiles []string `protobuf:"bytes,9,rep,name=wrapped_native_coin_precompiles,json=wrappedNativeCoinPrecompiles,proto3" json:"wrapped_native_coin_precompiles,omitempty"`
	// active_dynamic_precompiles defines the slice of hex addresses of the
	// precompiled contracts that are active and can be dynamically added
	ActiveDynamicPrecompiles []string `protobuf:"bytes,10,rep,name=active_dynamic_precompiles,json=activeDynamicPrecompiles,proto3" json:"active_dynamic_precompiles,omitempty"`
	...
	// whitelisted_create_addresses defines the slice of hex addresses that are
	// whitelisted for contract creation
	WhitelistedCreateAddresses []string `protobuf:"bytes,12,rep,name=whitelisted_create_addresses,json=whitelistedCreateAddresses,proto3" json:"whitelisted_create_addresses,omitempty"`
}
...
func (m *Params) GetWrappedNativeCoinPrecompiles() []string {
	if m != nil {
		return m.WrappedNativeCoinPrecompiles
	}
	return nil
}

func (m *Params) GetActiveDynamicPrecompiles() []string {
	if m != nil {
...
func (m *Params) GetWhitelistedCreateAddresses() []string {
	if m != nil {
		return m.WhitelistedCreateAddresses
	}
	return nil
}
...
var fileDescriptor_d21ecc92c8c8583e = []byte{
	...
	,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.WhitelistedCreateAddresses) > 0 {
		for iNdEx := len(m.WhitelistedCreateAddresses) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.WhitelistedCreateAddresses[iNdEx])
			copy(dAtA[i:], m.WhitelistedCreateAddresses[iNdEx])
			i = encodeVarintEvm(dAtA, i, uint64(len(m.WhitelistedCreateAddresses[iNdEx])))
			i--
			dAtA[i] = 0x62
		}
	}
	...
	if len(m.ActiveDynamicPrecompiles) > 0 {
		for iNdEx := len(m.ActiveDynamicPrecompiles) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.ActiveDynamicPrecompiles[iNdEx])
			copy(dAtA[i:], m.ActiveDynamicPrecompiles[iNdEx])
			i = encodeVarintEvm(dAtA, i, uint64(len(m.ActiveDynamicPrecompiles[iNdEx])))
			i--
			dAtA[i] = 0x52
		}
	}
	if len(m.WrappedNativeCoinPrecompiles) > 0 {
		for iNdEx := len(m.WrappedNativeCoinPrecompiles) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.WrappedNativeCoinPrecompiles[iNdEx])
			copy(dAtA[i:], m.WrappedNativeCoinPrecompiles[iNdEx])
			i = encodeVarintEvm(dAtA, i, uint64(len(m.WrappedNativeCoinPrecompiles[iNdEx])))
			i--
			dAtA[i] = 0x4a
		}
	}
...
func (m *Params) Size() (n int) {
	...
	if len(m.WrappedNativeCoinPrecompiles) > 0 {
		for _, s := range m.WrappedNativeCoinPrecompiles {
			l = len(s)
			n += 1 + l + sovEvm(uint64(l))
		}
	}
	if len(m.ActiveDynamicPrecompiles) > 0 {
		for _, s := range m.ActiveDynamicPrecompiles {
			l = len(s)
			n += 1 + l + sovEvm(uint64(l))
		}
	}
	...
	if len(m.WhitelistedCreateAddresses) > 0 {
		for _, s := range m.WhitelistedCreateAddresses {
			l = len(s)
			n += 1 + l + sovEvm(uint64(l))
		}
	}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field WrappedNativeCoinPrecompiles", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.WrappedNativeCoinPrecompiles = append(m.WrappedNativeCoinPrecompiles, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 10:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ActiveDynamicPrecompiles", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ActiveDynamicPrecompiles = append(m.ActiveDynamicPrecompiles, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 11:
			if wireType != 2 {
		...
		case 12:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field WhitelistedCreateAddresses", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.WhitelistedCreateAddresses = append(m.WhitelistedCreateAddresses, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
