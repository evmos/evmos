...
func TestParamsValidate(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name:    "valid",
			params:  NewParams(DefaultEVMDenom, false, true, true, DefaultChainConfig(), extraEips, []string{}, []string{}, []string{}),
			expPass: true,
		},
		{
			name:        "empty",
...
func TestParamsEIPs(t *testing.T) {
	extraEips := []int64{2929, 1884, 1344}
	params := NewParams("ara", false, true, true, DefaultChainConfig(), extraEips, nil, []string{}, []string{})
	actual := params.EIPs()
