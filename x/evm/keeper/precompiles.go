...
func AvailablePrecompiles(
	...
	strideOutpost, err := strideoutpost.NewPrecompile(transfertypes.PortID, strideoutpost.StrideChannelIDMainnet, transferKeeper, erc20Keeper, authzKeeper, stakingKeeper)
	if err != nil {
