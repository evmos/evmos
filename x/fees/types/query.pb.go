...
// method.
type QueryWithdrawFeesRequest struct {
	// withdraw bech32 address
...
func (m *QueryWithdrawFeesRequest) Reset()         { *m = QueryWithdrawFeesRequest{} }
func (m *QueryWithdrawFeesRequest) String() string { return proto.CompactTextString(m) }
func (*QueryWithdrawFeesRequest) ProtoMessage()    {}
func (*QueryWithdrawFeesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_6533658f63002c05, []int{8}
}
func (m *QueryWithdrawFeesRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryWithdrawFeesRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryWithdrawFeesRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryWithdrawFeesRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryWithdrawFeesRequest.Merge(m, src)
}
func (m *QueryWithdrawFeesRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryWithdrawFeesRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryWithdrawFeesRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryWithdrawFeesRequest proto.InternalMessageInfo

func (m *QueryWithdrawFeesRequest) GetWithdrawAddress() string {
	if m != nil {
...
func (m *QueryWithdrawFeesRequest) GetPagination() *query.PageRequest {
	if m != nil {
		return m.Pagination
	}
	return nil
...
// method.
type QueryWithdrawFeesResponse struct {
	ContractAddresses []string `protobuf:"bytes,1,rep,name=contract_addresses,json=contractAddresses,proto3" json:"contract_addresses,omitempty"`
	// pagination defines the pagination in the response.
	Pagination *query.PageResponse `protobuf:"bytes,2,opt,name=pagination,proto3" json:"pagination,omitempty"`
}

func (m *QueryWithdrawFeesResponse) Reset()         { *m = QueryWithdrawFeesResponse{} }
func (m *QueryWithdrawFeesResponse) String() string { return proto.CompactTextString(m) }
func (*QueryWithdrawFeesResponse) ProtoMessage()    {}
func (*QueryWithdrawFeesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_6533658f63002c05, []int{9}
}
func (m *QueryWithdrawFeesResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryWithdrawFeesResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryWithdrawFeesResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryWithdrawFeesResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryWithdrawFeesResponse.Merge(m, src)
}
func (m *QueryWithdrawFeesResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryWithdrawFeesResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryWithdrawFeesResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryWithdrawFeesResponse proto.InternalMessageInfo

func (m *QueryWithdrawFeesResponse) GetContractAddresses() []string {
	if m != nil {
		return m.ContractAddresses
	}
	return nil
...
func (m *QueryWithdrawFeesResponse) GetPagination() *query.PageResponse {
	if m != nil {
		return m.Pagination
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*QueryWithdrawFeesRequest)(nil), "evmos.fees.v1.QueryWithdrawFeesRequest")
	proto.RegisterType((*QueryWithdrawFeesResponse)(nil), "evmos.fees.v1.QueryWithdrawFeesResponse")
}
...
var fileDescriptor_6533658f63002c05 = []byte{
	...
	,
}
...
type QueryClient interface {
	...
	// WithdrawFees retrieves all fees with a given withdraw address
	WithdrawFees(ctx context.Context, in *QueryWithdrawFeesRequest, opts ...grpc.CallOption) (*QueryWithdrawFeesResponse, error)
}
...
func (c *queryClient) WithdrawFees(ctx context.Context, in *QueryWithdrawFeesRequest, opts ...grpc.CallOption) (*QueryWithdrawFeesResponse, error) {
	out := new(QueryWithdrawFeesResponse)
	err := c.cc.Invoke(ctx, "/evmos.fees.v1.Query/WithdrawFees", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type QueryServer interface {
	...
	// WithdrawFees retrieves all fees with a given withdraw address
	WithdrawFees(context.Context, *QueryWithdrawFeesRequest) (*QueryWithdrawFeesResponse, error)
}
...
func (*UnimplementedQueryServer) WithdrawFees(ctx context.Context, req *QueryWithdrawFeesRequest) (*QueryWithdrawFeesResponse, error) {
...
func _Query_WithdrawFees_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryWithdrawFeesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).WithdrawFees(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/evmos.fees.v1.Query/WithdrawFees",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).WithdrawFees(ctx, req.(*QueryWithdrawFeesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Query_WithdrawFees_Handler,
		},
	},
...
func (m *QueryWithdrawFeesRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryWithdrawFeesRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryWithdrawFeesRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryWithdrawFeesResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryWithdrawFeesResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryWithdrawFeesResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryWithdrawFeesRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryWithdrawFeesResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryWithdrawFeesRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryWithdrawFeesRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryWithdrawFeesRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QueryWithdrawFeesResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryWithdrawFeesResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryWithdrawFeesResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
