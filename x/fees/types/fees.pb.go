...
func (m *Fee) GetWithdrawerAddress() string {
	if m != nil {
...
var fileDescriptor_1527b6d4bf16c067 = []byte{
	...
	0xf9, 0x42, 0xbc, 0x60, 0x19, 0x3d, 0xb0, 0x48, 0x99, 0xa1, 0x52, 0x17, 0x23, 0x17, 0xb3, 0x5b,
	...
	0x51, 0x0a, 0x13, 0x87, 0x29, 0xd5, 0xe5, 0x12, 0x2a, 0xcf, 0x2c, 0xc9, 0x48, 0x29, 0x4a, 0x2c,
	0x47, 0x52, 0xcc, 0x0c, 0x56, 0x2c, 0x88, 0x90, 0x81, 0x2a, 0x77, 0x72, 0x38, 0xf1, 0x48, 0x8e,
	...
	0xfc, 0x5c, 0x7d, 0x88, 0xd7, 0x20, 0x64, 0x99, 0xa9, 0x7e, 0x05, 0xc4, 0x97, 0x25, 0x95, 0x05,
	0xa9, 0xc5, 0x49, 0x6c, 0x60, 0x4f, 0x1a, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0x53, 0x4d, 0x47,
	0xea, 0x00, 0x01, 0x00, 0x00,
}
...
func (m *Fee) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.WithdrawerAddress) > 0 {
		...
		i = encodeVarintFees(dAtA, i, uint64(len(m.WithdrawerAddress)))
		i--
		dAtA[i] = 0x1a
	}
