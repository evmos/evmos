...
// GovKeeper defines the expected governance keeper interface used on fees
...
// InflationKeeper defines the expected mint keeper interface used on fees
...
// Stakekeeper defines the expected staking keeper interface used on fees
