...
replace (
	...
	// this is bad form and should be fixed (cosmos-proto replace)
	github.com/cosmos/cosmos-proto => github.com/cosmos/cosmos-proto v1.0.0-beta.2

	// use Cosmos-SDK fork to enable Ledger functionality
	// NOTE: NEED TO PORT THE LEDGER CODE BACK TO 47
	...
	// this is bad form and should be fixed (protobuf replace)
	// one of the ideas with 47 is we should not need this anymore
