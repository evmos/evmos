...
>>>>>>> 321a90d3 (chore(dep): update versiondb to fix memStore bug (#1964))
...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/evmos/cosmos-sdk v0.47.5-evmos.0.20231027081840-e48d219220db
	// use Evmos geth fork
