...
`,
	...
	cmd.Flags().Bool(srvflags.GRPCEnable, false, "Define if the gRPC server should be enabled")
	cmd.Flags().String(srvflags.GRPCAddress, serverconfig.DefaultGRPCAddress, "the gRPC server address to listen on")
	cmd.Flags().Bool(srvflags.GRPCWebEnable, false, "Define if the gRPC-Web server should be enabled. (Note: gRPC must also be enabled.)")
	...
	cmd.Flags().Bool(srvflags.JSONRPCEnable, false, "Define if the JSON-RPC server should be enabled")
