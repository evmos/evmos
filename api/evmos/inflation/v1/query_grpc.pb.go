...
const (
	Query_Period_FullMethodName             = "/eidon-chain.inflation.v1.Query/Period"
	Query_EpochMintProvision_FullMethodName = "/eidon-chain.inflation.v1.Query/EpochMintProvision"
	Query_SkippedEpochs_FullMethodName      = "/eidon-chain.inflation.v1.Query/SkippedEpochs"
	Query_CirculatingSupply_FullMethodName  = "/eidon-chain.inflation.v1.Query/CirculatingSupply"
	Query_InflationRate_FullMethodName      = "/eidon-chain.inflation.v1.Query/InflationRate"
	Query_Params_FullMethodName             = "/eidon-chain.inflation.v1.Query/Params"
)
