...
const (
	Msg_CreateClawbackVestingAccount_FullMethodName = "/eidon-chain.vesting.v2.Msg/CreateClawbackVestingAccount"
	Msg_FundVestingAccount_FullMethodName           = "/eidon-chain.vesting.v2.Msg/FundVestingAccount"
	Msg_Clawback_FullMethodName                     = "/eidon-chain.vesting.v2.Msg/Clawback"
	Msg_UpdateVestingFunder_FullMethodName          = "/eidon-chain.vesting.v2.Msg/UpdateVestingFunder"
	Msg_ConvertVestingAccount_FullMethodName        = "/eidon-chain.vesting.v2.Msg/ConvertVestingAccount"
)
