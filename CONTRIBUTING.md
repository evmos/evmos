...
1. Either [open](https://github.com/Canto-Network/canto/issues/new/choose)
   or [find](https://github.com/Canto-Network/canto/issues) an issue you have identified and would like to contribute to
   resolving.
...
some [good first issues](https://github.com/Canto-Network/canto/issues?q=label%3A%22good+first+issue%22).

## <span id="adr">Architecture Decision Records (ADR)</span>

When proposing an architecture decision for Evmos, please create
an [ADR](https://github.com/Canto-Network/canto/blob/main/docs/architecture/README.md) so further discussions can be
...
at `https://github.com/Canto-Network/canto`, the code should never exist
at `$GOPATH/src/github.com/Canto-Network/canto`. Instead, we use `git remote` to add the fork as a new remote for the
original repo,`$GOPATH/src/github.com/Canto-Network/canto`, and do all the work there.

For instance, to create a fork and work on a branch of it, you would:

1. Create the fork on github, using the fork button.
2. Go to the original repo checked out locally. (i.e. `$GOPATH/src/github.com/Canto-Network/canto`)
...
4. Create your feature branch from `development` either on `github.com/Canto-Network/canto`, or your fork (
