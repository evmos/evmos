...
1. Either [open](https://github.com/hazlorlabs/hsc/issues/new/choose)
   or [find](https://github.com/hazlorlabs/hsc/issues) an issue you have identified and would like to contribute to
   resolving.
...
some [good first issues](https://github.com/hazlorlabs/hsc/issues?q=label%3A%22good+first+issue%22).
...
at `https://github.com/hazlorlabs/hsc`, the code should never exist
at `$GOPATH/src/github.com/hazlorlabs/hsc`. Instead, we use `git remote` to add the fork as a new remote for the
original repo,`$GOPATH/src/github.com/hazlorlabs/hsc`, and do all the work there.

For instance, to create a fork and work on a branch of it, you would:

1. Create the fork on github, using the fork button.
2. Go to the original repo checked out locally. (i.e. `$GOPATH/src/github.com/hazlorlabs/hsc`)
...
4. Create your feature branch from `development` either on `github.com/hazlorlabs/hsc`, or your fork (
