...
import (
	...
	"github.com/Eidon-AI/eidon-chain/v20/precompiles/common"
...
func TestNewCoinsResponse(t *testing.T) {
	...
	for _, tc := range testCases {
		coin := sdk.NewCoin(eidon-chaintypes.BaseDenom, tc.amount)
...
func TestNewDecCoinsResponse(t *testing.T) {
	...
	for _, tc := range testCases {
		coin := sdk.NewDecCoin(eidon-chaintypes.BaseDenom, tc.amount)
