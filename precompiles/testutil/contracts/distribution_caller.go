...
var (
	...
	// DistributionCallerHardhatContract is the compiled contract calling the distribution precompile
	// generated by HardHat.
	DistributionCallerHardhatContract evmtypes.HardhatCompiledContract
...
func init() {
	err := json.Unmarshal(DistributionCallerJSON, &DistributionCallerHardhatContract)
	if err != nil {
		panic(err)
	}

	DistributionCallerContract, err = DistributionCallerHardhatContract.ToCompiledContract()
	if err != nil {
		panic(err)
	}
