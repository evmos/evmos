...
type ERC20Keeper interface {
	...
	MintCoins(ctx sdk.Context, sender, to sdk.AccAddress, coins sdk.Coins, token string) error
	// Burn burns tokens from the given address
	BurnCoins(ctx sdk.Context, sender sdk.AccAddress, coins sdk.Coins, token string) error
	...
	TransferOwnership(ctx sdk.Context, sender, newOwner sdk.AccAddress, token string) error
}
