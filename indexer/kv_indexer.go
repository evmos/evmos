...
var _ eidon-chaintypes.EVMTxIndexer = &KVIndexer{}
...
func (kv *KVIndexer) IndexBlock(block *cmttypes.Block, txResults []*abci.ExecTxResult) error {
	...
	for txIndex, tx := range block.Txs {
		...
		for msgIndex, msg := range tx.GetMsgs() {
			...
			txResult := eidon-chaintypes.TxResult{
				Height:     height,
...
func (kv *KVIndexer) GetByTxHash(hash common.Hash) (*eidon-chaintypes.TxResult, error) {
	...
	var txKey eidon-chaintypes.TxResult
...
func (kv *KVIndexer) GetByBlockAndIndex(blockNumber int64, txIndex int32) (*eidon-chaintypes.TxResult, error) {
...
func saveTxResult(codec codec.Codec, batch dbm.Batch, txHash common.Hash, txResult *eidon-chaintypes.TxResult) error {
