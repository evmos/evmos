...
| `https://evmos-mainnet.public.blastapi.io`    | `RPC` `API`            | [BLAST - Bwarelabs](https://blastapi.io/)         |
| `wss://evmos-mainnet.public.blastapi.io`      | `Websocket` `API`      | [BLAST - Bwarelabs](https://blastapi.io/)         |
