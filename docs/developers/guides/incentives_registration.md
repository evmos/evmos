...
2. Promote understanding of the `x/incentives` Module.
    ...
    Make sure to mention the [`x/incentives` Module Documentation](../../../x/incentives/spec/README.md)
...
with [`evmosd`](../../validators/quickstart/binary.md),
...
[here](../../../x/incentives/spec/08_clients.md#clients) can produce useful analysis.
