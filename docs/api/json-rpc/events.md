...
```bash
hscd start --rpc.laddr="tcp://127.0.0.1:26657"
```
...
```bash
hscd start  --json-rpc.address"0.0.0.0:8545" --json-rpc.ws-address="0.0.0.0:8546" --evm.rpc.api="eth,web3,net,txpool,debug" --json-rpc.enable
```
