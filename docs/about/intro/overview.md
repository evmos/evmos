...
Learn about Evoblock and its primary features. {synopsis}
...
Evoblock allows for running vanilla Ethereum as a [Cosmos](https://cosmos.network/)
...
Here’s a glance at some of the key features of Evoblock:
...
Evoblock enables these key features by:
...
| Property               | Value                                                      |
| ---------------------- | ---------------------------------------------------------- |
| Evoblock Testnet          | `{{ $themeConfig.project.testnet_chain_id }}`              |
| Evoblock Mainnet          | `{{ $themeConfig.project.chain_id }}`                      |
