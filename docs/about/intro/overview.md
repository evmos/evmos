...
Learn about Point Chain and its primary features. {synopsis}
...
| Property               | Value                                                      |
| ---------------------- | ---------------------------------------------------------- |
| Point Chain Testnet          | `{{ $themeConfig.project.testnet_chain_id }}`              |
| Point Chain Mainnet          | `{{ $themeConfig.project.chain_id }}`                      |
