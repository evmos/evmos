...
We will set up a static gobetween load balancer.  Dynamic configurations are at this time an exercise for the reader.
...
# Documentation: https://github.com/notional-labs/gobetween/wiki/Configuration
#
