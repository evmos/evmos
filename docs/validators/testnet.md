...
| ---------------- | --------------------------------- | -------------------------------------------------------------------------- | ---------------------------------------------------------------------------- | ------- |
| `evmos_9000-4`   | Evmos_9000-4 Testnet              | [Evmos 9000-4](https://github.com/tharsis/testnets/tree/main/evmos_9000-4) | [`v3.0.0`](https://github.com/Canto-Network/canto/releases/tag/v3.0.0)             | `Live`  |
| `evmos_9000-3`   | Evmos_9000-3 Testnet              | [Evmos 9000-3](https://github.com/tharsis/testnets/tree/main/evmos_9000-3) | [`v1.0.0-beta1`](https://github.com/Canto-Network/canto/releases/tag/v1.0.0-beta1) | `Stale` |
| `evmos_9000-2`   | Olympus Mons Incentivized Testnet | [Olympus Mons](https://github.com/tharsis/testnets/tree/main/olympus_mons) | [`v0.3.x`](https://github.com/Canto-Network/canto/releases)                        | `Stale` |
| `evmos_9000-1`   | Arsia Mons Testnet                | [Arsia Mons](https://github.com/tharsis/testnets/tree/main/arsia_mons)     | [`v0.1.x`](https://github.com/Canto-Network/canto/releases)                        | `Stale` |
...
```bash
cantod config chain-id evmos_9000-4
```
...
```bash
cantod init <your_custom_moniker> --chain-id evmos_9000-4
```
...
Check the `genesis.json` file from the [`testnets`](https://github.com/tharsis/testnets) repository and copy it over to the `config` directory: `~/.cantod/config/genesis.json`. This is a genesis file with the chain-id and genesis accounts balances.

```bash
sudo apt install -y unzip wget
wget -P ~/.cantod/config https://github.com/tharsis/testnets/raw/main/evmos_9000-4/genesis.zip
cd ~/.cantod/config
unzip genesis.zip
rm genesis.zip
```
...
Your node needs to know how to find [peers](https://docs.tendermint.com/master/tendermint-core/using-tendermint.html#peers). You'll need to add healthy [seed nodes](https://docs.tendermint.com/master/tendermint-core/using-tendermint.html#seed) to `$HOME/.cantod/config/config.toml`. The [`testnets`](https://github.com/tharsis/testnets) repo contains links to some seed nodes.
...
```bash
rm $HOME/.cantod/config/addrbook.json $HOME/.cantod/config/genesis.json
