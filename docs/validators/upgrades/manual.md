...
Next, upgrade the software to the desired release version. Check the Evmos [releases page](https://github.com/pointnetwork/point-chain/releases) for details on each release.
