...
Next, upgrade the software to the desired release version. Check the Evmos [releases page](https://github.com/Canto-Network/canto/releases) for details on each release.
