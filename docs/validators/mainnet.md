...
| -------------- | ------------- | ------------------------------------------------------------------ | ----------------------------------------------------- | ---------- |
| `evmos_9001-2` | Evmos Mainnet 2 | [Evmos](https://github.com/tharsis/mainnet/tree/main/evmos_9001-2) | [`v3.0.x`](https://github.com/Canto-Network/canto/releases) | `Not Live` |
| `evmos_9001-1` | Evmos Mainnet 1 | [Evmos](https://github.com/tharsis/mainnet/tree/main/evmos_9001-1) | [`v2.0.1`](https://github.com/Canto-Network/canto/releases/v2.0.1) | `Stale` |
