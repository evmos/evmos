...
Learn how Evmos's architecture leverages the Cosmos SDK Proof-of-Stake functionality,
...
engine and a generic application interface. The consensus engine, called [Tendermint Core](https://docs.tendermint.com/),
...
that together support all the EVM state transitions while ensuring the same developer experience as Ethereum:
