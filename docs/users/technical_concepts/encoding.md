...
Learn about the encoding formats used on Point network. {synopsis}
...
previous versions, specially for client encoding and signing with Ledger devices. Point network does not
...
allows for quick reconstruction of encoded data. Point network uses RLP to encode/decode Ethereum
