...
```bash
evoblockd keys add --multisig=name1,name2,name3[...] --multisig-threshold=K new_key_name
```
...
```bash
evoblockd keys add --multisig=p1,p2,p3 --multisig-threshold=2 multisig_address
evoblockd keys add --multisig=p2,p3,p1 --multisig-threshold=2 multisig_address
```

Multisig addresses can also be generated on-the-fly and printed through the which command:

```bash
evoblockd keys show --multisig-threshold=K name1 name2 name3 [...]
```
...
Let's add 10 EVO to the multisig wallet:
