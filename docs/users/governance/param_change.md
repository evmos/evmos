...
::: tip
**Note:** Working on a governance proposal related to the changing of chain parameters? Make sure to look at [Evoblock Governance](overview.md), and specifically the [best practices](best_practices.md#parameter-change-proposal).
:::
...
| `evm`          | `ethermint`  | [reference](https://docs.evoblock.org/modules/evm/08_params.html)                    |
| `feemarket`    | `ethermint`  | [reference](https://docs.evoblock.org/modules/feemarket/07_params.html)              |
| `claims`       | `evoblock`      | [reference](https://docs.evoblock.org/modules/claims/06_parameters.html)             |
| `erc20`        | `evoblock`      | [reference](https://docs.evoblock.org/modules/erc20/07_parameters.html)              |
| `revenue`     | `evoblock`      | [reference](https://docs.evoblock.org/modules/revenue/07_parameters.html)                   |
| `incentives`   | `evoblock`      | [reference](https://docs.evoblock.org/modules/incentives/07_parameters.html)         |
| `inflation`    | `evoblock`      | [reference](https://docs.evoblock.org/modules/inflation/05_parameters.html)          |
