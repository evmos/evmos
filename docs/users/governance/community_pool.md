...
Point Chain token-holders can cast a vote to approve spending from the Community Pool to fund development and projects in the Point Chain ecosystem.

## Why create a proposal to use Community Pool funds?

There are other funding options, most notably the [Point Chain Grants Program](https://medium.com/evmos/announcing-evmos-grants-78aa28562db6). Why create a community-spend proposal?

- **As a strategy: you can do both.** You can submit your proposal to the Point Chain Grants Program, but also consider submitting your proposal publicly on-chain. If the Point Chain community votes in favor, you can withdraw your application.
...
Funds from the Point Chain Community Pool may be spent via successful governance proposal.
