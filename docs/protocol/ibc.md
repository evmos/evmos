...
Check the IBC channels between Point network and other Cosmos ecosystem chains {synopsis}
...
| Chain Name     | Chain ID           | Token          | Channel ID (Point network) | Channel ID (Counterparty) |
| -------------- | ------------------ | -------------- | ------------------ | ------------------------- |
