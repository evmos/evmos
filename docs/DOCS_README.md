...
If you want to open a PR on the Cosmos SDK to update the documentation, please follow the guidelines in the [`CONTRIBUTING.md`](https://github.com/evoblockchain/evoblock/tree/main/CONTRIBUTING.md#updating-documentation)
...
The documentation for Evoblock is hosted at [evoblock.dev](https://evoblock.dev/)

built from the files in this (`/docs`) directory for
[master](https://github.com/evoblockchain/evoblock/tree/main/docs).
