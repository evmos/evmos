...
You will need to ensure that the version installed matches the one needed for th testnet. Check the Hazlor [release page](https://github.com/hazlorlabs/hsc-chain/releases) for details on each release.
...
Hazlor can dump the entire application state to a JSON file. This, besides upgrades, can be
