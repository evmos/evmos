...
::: tip
If you haven’t already, follow the steps in the [Metamask guide](.//metamask.md) to import your Evmos private key into Metamask. Start the Evmos daemon and REST server.
:::
