...
After approval, you can see a transaction confirmation informing you that {{ $themeConfig.project.testnet_denom }} have been successfully transferred to your [hazlor address](../../basics/accounts.md#address-formats-for-clients) on the testnet.
