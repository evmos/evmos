...
// DefaultDenom defines the default denom used for testing
const DefaultDenom = "aevmos"
...
func Setup(
	...
	balance := banktypes.Balance{
		...
		Coins:   sdk.NewCoins(sdk.NewCoin(DefaultDenom, sdk.NewInt(100000000000000))),
	}
...
func GenesisStateWithValSet(app *Evmos, genesisState simapp.GenesisState,
	...
	stakingparams.BondDenom = DefaultDenom
	...
	for range delegations {
		...
		totalSupply = totalSupply.Add(sdk.NewCoin(DefaultDenom, bondAmt))
	}

	// add bonded amount to bonded pool module account
	balances = append(balances, banktypes.Balance{
		Address: authtypes.NewModuleAddress(stakingtypes.BondedPoolName).String(),
		Coins:   sdk.Coins{sdk.NewCoin(DefaultDenom, bondAmt)},
	})
