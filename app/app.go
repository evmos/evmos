...
import (
	...
	ethermintapp "github.com/evoblockchain/ethermint/app"
	...
	_ "github.com/evoblockchain/evoblock/v8/client/docs/statik"

	"github.com/evoblockchain/evoblock/v8/app/ante"
	...
	v8 "github.com/evoblockchain/evoblock/v8/app/upgrades/v8"
	v81 "github.com/evoblockchain/evoblock/v8/app/upgrades/v8_1"
	...
	"github.com/evoblockchain/evoblock/v8/x/epochs"
	epochskeeper "github.com/evoblockchain/evoblock/v8/x/epochs/keeper"
	epochstypes "github.com/evoblockchain/evoblock/v8/x/epochs/types"
	"github.com/evoblockchain/evoblock/v8/x/erc20"
	erc20client "github.com/evoblockchain/evoblock/v8/x/erc20/client"
	erc20keeper "github.com/evoblockchain/evoblock/v8/x/erc20/keeper"
	erc20types "github.com/evoblockchain/evoblock/v8/x/erc20/types"
	"github.com/evoblockchain/evoblock/v8/x/incentives"
	incentivesclient "github.com/evoblockchain/evoblock/v8/x/incentives/client"
	incentiveskeeper "github.com/evoblockchain/evoblock/v8/x/incentives/keeper"
	incentivestypes "github.com/evoblockchain/evoblock/v8/x/incentives/types"
	"github.com/evoblockchain/evoblock/v8/x/inflation"
	...
	"github.com/evoblockchain/evoblock/v8/x/recovery"
	recoverykeeper "github.com/evoblockchain/evoblock/v8/x/recovery/keeper"
	recoverytypes "github.com/evoblockchain/evoblock/v8/x/recovery/types"
	"github.com/evoblockchain/evoblock/v8/x/revenue"
	revenuekeeper "github.com/evoblockchain/evoblock/v8/x/revenue/keeper"
	revenuetypes "github.com/evoblockchain/evoblock/v8/x/revenue/types"
	"github.com/evoblockchain/evoblock/v8/x/vesting"
	vestingkeeper "github.com/evoblockchain/evoblock/v8/x/vesting/keeper"
...
func init() {
	...
	DefaultNodeHome = filepath.Join(userHomeDir, ".evoblockd")

	// manually update the power reduction by replacing micro (u) -> atto (a) evoblock
...
var (
	_ servertypes.Application = (*Evoblock)(nil)
	_ simapp.App              = (*Evoblock)(nil)
	_ ibctesting.TestingApp   = (*Evoblock)(nil)
)

// Evoblock implements an extended ABCI application. It is an application
// that may process transactions through Ethereum's EVM running atop of
// Tendermint consensus.
type Evoblock struct {
	*baseapp.BaseApp
...
// NewEvoblock returns a reference to a new initialized Ethermint application.
func NewEvoblock(
	logger log.Logger,
	db dbm.DB,
...
func (app *Evoblock) Name() string { return app.BaseApp.Name() }
...
func (app *Evoblock) BeginBlocker(ctx sdk.Context, req abci.RequestBeginBlock) abci.ResponseBeginBlock {
...
func (app *Evoblock) EndBlocker(ctx sdk.Context, req abci.RequestEndBlock) abci.ResponseEndBlock {
	return app.mm.EndBlock(ctx, req)
}

// We are intentionally decomposing the DeliverTx method so as to calculate the transactions per second.
func (app *Evoblock) DeliverTx(req abci.RequestDeliverTx) (res abci.ResponseDeliverTx) {
	defer func() {
...
func (app *Evoblock) InitChainer(ctx sdk.Context, req abci.RequestInitChain) abci.ResponseInitChain {
...
func (app *Evoblock) LoadHeight(height int64) error {
	return app.LoadVersion(height)
}

// ModuleAccountAddrs returns all the app's module account addresses.
func (app *Evoblock) ModuleAccountAddrs() map[string]bool {
...
func (app *Evoblock) BlockedAddrs() map[string]bool {
...
// LegacyAmino returns Evoblock's amino codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *Evoblock) LegacyAmino() *codec.LegacyAmino {
	return app.cdc
}

// AppCodec returns Evoblock's app codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *Evoblock) AppCodec() codec.Codec {
	return app.appCodec
}

// InterfaceRegistry returns Evoblock's InterfaceRegistry
func (app *Evoblock) InterfaceRegistry() types.InterfaceRegistry {
...
func (app *Evoblock) GetKey(storeKey string) *sdk.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *Evoblock) GetTKey(storeKey string) *sdk.TransientStoreKey {
...
func (app *Evoblock) GetMemKey(storeKey string) *sdk.MemoryStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *Evoblock) GetSubspace(moduleName string) paramstypes.Subspace {
	subspace, _ := app.ParamsKeeper.GetSubspace(moduleName)
	return subspace
}

// SimulationManager implements the SimulationApp interface
func (app *Evoblock) SimulationManager() *module.SimulationManager {
	return app.sm
}

// RegisterAPIRoutes registers all application module routes with the provided
// API server.
func (app *Evoblock) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *Evoblock) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.BaseApp.Simulate, app.interfaceRegistry)
}

func (app *Evoblock) RegisterTendermintService(clientCtx client.Context) {
...
func (app *Evoblock) GetBaseApp() *baseapp.BaseApp {
	return app.BaseApp
}

// GetStakingKeeper implements the TestingApp interface.
func (app *Evoblock) GetStakingKeeper() stakingkeeper.Keeper {
	return app.StakingKeeper
}

// GetIBCKeeper implements the TestingApp interface.
func (app *Evoblock) GetIBCKeeper() *ibckeeper.Keeper {
	return app.IBCKeeper
}

// GetScopedIBCKeeper implements the TestingApp interface.
func (app *Evoblock) GetScopedIBCKeeper() capabilitykeeper.ScopedKeeper {
	return app.ScopedIBCKeeper
}

// GetTxConfig implements the TestingApp interface.
func (app *Evoblock) GetTxConfig() client.TxConfig {
...
func (app *Evoblock) setupUpgradeHandlers() {
	// v2 upgrade handler
