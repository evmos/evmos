...
//
// 	sender := testutiltx.GenerateAddress()
...
// 		{"invalid transaction type", &evmtypes.MsgEthereumTx{}, func() {}, true, false},
// 		{
...
// 			tx,
// 			func() {
// 				vmdb.AddBalance(sender, big.NewInt(1000000))
// 			},
// 			true,
// 			true,
// 		},
...
// 			tx,
// 			func() {
// 				acc := suite.app.AccountKeeper.NewAccountWithAddress(suite.ctx, sender.Bytes())
...
// 		}
//
// 			ctx := suite.ctx.WithIsCheckTx(tc.checkTx)
// 			err := ethante.VerifyAccountBalance(ctx, suite.app.AccountKeeper, vmdb.Keeper().GetAccount(ctx, sender), sender, tc.tx.GetMsgs()[0].)
//
// 			if tc.expPass {
