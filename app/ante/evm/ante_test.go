	...
	testCases := []struct {
		...
		},
		{
			...
			func() sdk.Tx {
				...
				amount := sdk.NewCoins(coinAmount)
				gas := uint64(200000)
				txBuilder := suite.CreateTestEIP712MsgCreateValidator(from, privKey, suite.ctx.ChainID(), gas, amount)
				return txBuilder.GetTx()
			}, false, false, true,
		},
		{
			...
			func() sdk.Tx {
				...
				amount := sdk.NewCoins(coinAmount)
				gas := uint64(200000)
				txBuilder := suite.CreateTestEIP712MsgCreateValidator2(from, privKey, suite.ctx.ChainID(), gas, amount)
				return txBuilder.GetTx()
			}, false, false, true,
		},
		{
			...
			func() sdk.Tx {
				...
				txBuilder := suite.CreateTestEIP712SubmitProposal(from, privKey, suite.ctx.ChainID(), gas, gasAmount, deposit)
				return txBuilder.GetTx()
			}, false, false, true,
		},
		{
			...
			func() sdk.Tx {
				...
				suite.Require().NoError(err)
				return suite.CreateTestEIP712SingleMessageTxBuilder(from, privKey, suite.ctx.ChainID(), gas, gasAmount, msg).GetTx()
			}, false, false, true,
		},

		{
			...
			func() sdk.Tx {
				...
				gasAmount := sdk.NewCoins(coinAmount)
				gas := uint64(200000)
				txBuilder := suite.CreateTestEIP712GrantAllowance(from, privKey, suite.ctx.ChainID(), gas, gasAmount)
				return txBuilder.GetTx()
			}, false, false, true,
		},
		{
			...
			func() sdk.Tx {
				...
				amount := sdk.NewCoins(coinAmount)
				gas := uint64(200000)
				txBuilder := suite.CreateTestEIP712MsgEditValidator(from, privKey, suite.ctx.ChainID(), gas, amount)
				return txBuilder.GetTx()
			}, false, false, true,
		},
		{
			...
			func() sdk.Tx {
				...
				amount := sdk.NewCoins(coinAmount)
				gas := uint64(200000)
				txBuilder := suite.CreateTestEIP712MsgSubmitEvidence(from, privKey, suite.ctx.ChainID(), gas, amount)
				return txBuilder.GetTx()
			}, false, false, true,
		},
		{
			...
			func() sdk.Tx {
				...
				amount := sdk.NewCoins(coinAmount)
				gas := uint64(200000)
				txBuilder := suite.CreateTestEIP712SubmitProposalV1(from, privKey, suite.ctx.ChainID(), gas, amount)
				return txBuilder.GetTx()
			}, false, false, true,
		},
		{
			...
			func() sdk.Tx {
				...
				amount := sdk.NewCoins(coinAmount)
				gas := uint64(200000)
				txBuilder := suite.CreateTestEIP712MsgExec(from, privKey, suite.ctx.ChainID(), gas, amount)
				return txBuilder.GetTx()
			}, false, false, true,
		},
		{
			...
			func() sdk.Tx {
				...
				amount := sdk.NewCoins(coinAmount)
				gas := uint64(200000)
				txBuilder := suite.CreateTestEIP712MsgVoteV1(from, privKey, suite.ctx.ChainID(), gas, amount)
				return txBuilder.GetTx()
			}, false, false, true,
		},
		{
			...
			func() sdk.Tx {
				...
				amount := sdk.NewCoins(coinAmount)
				gas := uint64(200000)
				txBuilder := suite.CreateTestEIP712MultipleMsgSend(from, privKey, suite.ctx.ChainID(), gas, amount)
				return txBuilder.GetTx()
			}, false, false, true,
		},
		{
			...
			func() sdk.Tx {
				...
				amount := sdk.NewCoins(coinAmount)
				gas := uint64(200000)
				txBuilder := suite.CreateTestEIP712MultipleDifferentMsgs(from, privKey, suite.ctx.ChainID(), gas, amount)
				return txBuilder.GetTx()
		...
		},
		{
			...
			func() sdk.Tx {
				...
				amount := sdk.NewCoins(coinAmount)
				gas := uint64(200000)
				txBuilder := suite.CreateTestEIP712SameMsgDifferentSchemas(from, privKey, suite.ctx.ChainID(), gas, amount)
				return txBuilder.GetTx()
			}, false, false, !suite.useLegacyEIP712TypedData,
		},
		{
			...
			func() sdk.Tx {
				...
				amount := sdk.NewCoins(coinAmount)
				gas := uint64(200000)
				txBuilder := suite.CreateTestEIP712ZeroValueArray(from, privKey, suite.ctx.ChainID(), gas, amount)
				return txBuilder.GetTx()
			}, false, false, !suite.useLegacyEIP712TypedData,
		},
		{
			...
			func() sdk.Tx {
				...
				amount := sdk.NewCoins(coinAmount)
				gas := uint64(200000)
				txBuilder := suite.CreateTestEIP712ZeroValueNumber(from, privKey, suite.ctx.ChainID(), gas, amount)
				return txBuilder.GetTx()
			}, false, false, !suite.useLegacyEIP712TypedData,
		},
		{
			...
			func() sdk.Tx {
				...
				amount := sdk.NewCoins(coinAmount)
				gas := uint64(200000)
				txBuilder := suite.CreateTestEIP712MsgTransfer(from, privKey, suite.ctx.ChainID(), gas, amount)
				return txBuilder.GetTx()
			}, false, false, true,
		},
		{
			...
			func() sdk.Tx {
				...
				amount := sdk.NewCoins(coinAmount)
				gas := uint64(200000)
				txBuilder := suite.CreateTestEIP712MsgTransferWithoutMemo(from, privKey, suite.ctx.ChainID(), gas, amount)
				return txBuilder.GetTx()
			}, false, false, true,
		},
		{
			...
			func() sdk.Tx {
				...
				amount := sdk.NewCoins(coinAmount)
				gas := uint64(200000)
				txBuilder := suite.CreateTestEIP712MultipleSignerMsgs(from, privKey, suite.ctx.ChainID(), gas, amount)
				return txBuilder.GetTx()
			}, false, false, false,
		},
		{
			...
			func() sdk.Tx {
				...
				gas := uint64(200000)
				amount := sdk.NewCoins(sdk.NewCoin(evmtypes.DefaultEVMDenom, sdkmath.NewInt(100*int64(gas))))
				txBuilder := suite.CreateTestEIP712TxBuilderMsgSend(from, privKey, "evmos_9002-1", gas, amount)
				return txBuilder.GetTx()
			}, false, false, false,
		},
		{
		...
		},
		{
			...
			func() sdk.Tx {
				...
				gas := uint64(200000)
				amount := sdk.NewCoins(sdk.NewCoin(evmtypes.DefaultEVMDenom, sdkmath.NewInt(100*int64(gas))))
				txBuilder := suite.CreateTestEIP712TxBuilderMsgSend(from, privKey, "evmos_9001-1", gas, amount)
				return txBuilder.GetTx()
			}, false, false, false,
		},
		{
