...
- (app) [#2860](https://github.com/evmos/evmos/pull/2860) Refactor to use
`sdk.BaseDenom` and EVM denom and added app configurator.
- (vesting) [#2880](https://github.com/evmos/evmos/pull/2880) Fix free delegated amount on `addGrant`.
- (rpc) [#2877](https://github.com/evmos/evmos/pull/2877) Add revert reason for
`eth_estimateGas`.
