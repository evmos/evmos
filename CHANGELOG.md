...
## [v11.0.0-rc2] - 2023-01-24

### State Machine Breaking

- (deps) [#1269](https://github.com/evmos/evmos/pull/1269) Bump `ethermint` to [`v0.21.0-rc2`](https://github.com/evmos/ethermint/releases/tag/v0.21.0-rc2)
...
>>>>>>> ef71537 (chore(deps): bump SDK to v0.46.8-ledger (#1279))
