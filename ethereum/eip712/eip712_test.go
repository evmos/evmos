	...
	}{
		{
			...
			msgs: []sdk.Msg{
				banktypes.NewMsgSend(
					...
					suite.createTestAddress(),
					suite.makeCoins(config.Bech32Prefix, math.NewInt(1)),
				),
			},
			accountNumber: 8,
			sequence:      5,
		...
		},
		{
			...
			msgs: []sdk.Msg{
				stakingtypes.NewMsgDelegate(
					...
					suite.makeCoins(config.Bech32Prefix, math.NewInt(1))[0],
				),
			},
			accountNumber: 25,
			sequence:      78,
		...
		},
		{
			...
			msgs: []sdk.Msg{
				...
				stakingtypes.NewMsgDelegate(
					testAddress,
					sdk.ValAddress(suite.createTestAddress()),
					suite.makeCoins(config.Bech32Prefix, math.NewInt(5))[0],
				),
			},
			accountNumber: 25,
			sequence:      78,
		...
		},
		{
			...
			msgs: []sdk.Msg{
				...
				banktypes.NewMsgSend(
					testAddress,
					suite.createTestAddress(),
					suite.makeCoins(config.Bech32Prefix, math.NewInt(50)),
				),
			},
			accountNumber: 25,
			sequence:      78,
