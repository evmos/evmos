...
func DefaultConfig() Config {
	...
	app := app.NewEvmos(log.NewNopLogger(), dbm.NewMemDB(), nil, true, nil, dir, 0, simutils.NewAppOptionsWithFlagHome(dir), app.NoOpConfigurator, baseapp.SetChainID(chainID))
	return Config{
		Codec:             app.AppCodec(),
