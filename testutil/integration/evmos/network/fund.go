...
func (n *IntegrationNetwork) FundModuleAccount(recipientMod string, coins sdk.Coins) error {
	ctx := n.GetContext()
	...
	return n.app.BankKeeper.SendCoinsFromModuleToModule(ctx, inflationtypes.ModuleName, recipientMod, coins)
}
