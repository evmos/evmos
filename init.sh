...
cat $homedir/config/genesis.json | jq '.app_state["staking"]["params"]["bond_denom"]="aevmos"' > $homedir/config/tmp_genesis.json && mv $homedir/config/tmp_genesis.json $homedir/config/genesis.json
cat $homedir/config/genesis.json | jq '.app_state["crisis"]["constant_fee"]["denom"]="aevmos"' > $homedir/config/tmp_genesis.json && mv $homedir/config/tmp_genesis.json $homedir/config/genesis.json
cat $homedir/config/genesis.json | jq '.app_state["gov"]["deposit_params"]["min_deposit"][0]["denom"]="aevmos"' > $homedir/config/tmp_genesis.json && mv $homedir/config/tmp_genesis.json $homedir/config/genesis.json
cat $homedir/config/genesis.json | jq '.app_state["evm"]["params"]["evm_denom"]="aevmos"' > $homedir/config/tmp_genesis.json && mv $homedir/config/tmp_genesis.json $homedir/config/genesis.json
cat $homedir/config/genesis.json | jq '.app_state["inflation"]["params"]["mint_denom"]="aevmos"' > $homedir/config/tmp_genesis.json && mv $homedir/config/tmp_genesis.json $homedir/config/genesis.json
...
# Set claims decay
cat $homedir/config/genesis.json | jq '.app_state["claims"]["params"]["duration_of_decay"]="1000000s"' > $homedir/config/tmp_genesis.json && mv $homedir/config/tmp_genesis.json $homedir/config/genesis.json
cat $homedir/config/genesis.json | jq '.app_state["claims"]["params"]["duration_until_decay"]="100000s"' > $homedir/config/tmp_genesis.json && mv $homedir/config/tmp_genesis.json $homedir/config/genesis.json

# Claim module account:
# 0xA61808Fe40fEb8B3433778BBC2ecECCAA47c8c47 || evmos15cvq3ljql6utxseh0zau9m8ve2j8erz89m5wkz
cat $homedir/config/genesis.json | jq -r --arg amount_to_claim "$amount_to_claim" '.app_state["bank"]["balances"] += [{"address":"evmos15cvq3ljql6utxseh0zau9m8ve2j8erz89m5wkz","coins":[{"denom":"aevmos", "amount":$amount_to_claim}]}]' > $homedir/config/tmp_genesis.json && mv $homedir/config/tmp_genesis.json $homedir/config/genesis.json
