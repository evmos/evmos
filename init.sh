...
evmosd start --pruning=nothing $TRACE --log_level $LOGLEVEL --minimum-gas-prices=0.0001aphoton --optimint.aggregator=true --optimint.da_layer=mock --json-rpc.enable=false
