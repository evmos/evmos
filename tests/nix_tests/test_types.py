...
def test_block(eidon-chain_cluster, geth):
    # Perform block queries (eth_getBlockByNumber & eth_getBlockByHash)
    # on eidon-chain and geth nodes, and compare the responses
    # Case 1: block without transactions
    get_blocks(eidon-chain_cluster, geth, False)
    # Case 2: block with transactions
    get_blocks(eidon-chain_cluster, geth, True)


def get_blocks(eidon-chain_rpc_ws, geth, with_transactions):
    w3: Web3 = eidon-chain_rpc_ws.w3
    eth_rpc = w3.provider
    ...
    eidon-chain_blk = w3.eth.get_block(1)
    # Get existing block, no transactions
    eth_rsp = eth_rpc.make_request(
        "eth_getBlockByHash", [eidon-chain_blk["hash"].hex(), with_transactions]
    )
...
def test_accounts(eidon-chain_cluster, geth):
...
def test_syncing(eidon-chain_cluster, geth):
    w3: Web3 = eidon-chain_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_coinbase(eidon-chain_cluster, geth):
    w3: Web3 = eidon-chain_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_max_priority_fee(eidon-chain_cluster, geth):
    w3: Web3 = eidon-chain_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_gas_price(eidon-chain_cluster, geth):
    w3: Web3 = eidon-chain_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_block_number(eidon-chain_cluster, geth):
    w3: Web3 = eidon-chain_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_balance(eidon-chain_cluster, geth):
    w3: Web3 = eidon-chain_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_storage_at(eidon-chain_cluster, geth):
    w3: Web3 = eidon-chain_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_proof(eidon-chain_cluster, geth):
    # on eidon-chain the proof query will fail for block numbers <= 2
...
def test_get_code(eidon-chain_cluster, geth):
    w3: Web3 = eidon-chain_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_block_transaction_count(eidon-chain_cluster, geth):
    w3: Web3 = eidon-chain_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_transaction(eidon-chain_cluster, geth):
    w3: Web3 = eidon-chain_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_get_transaction_receipt(eidon-chain_cluster, geth):
    w3: Web3 = eidon-chain_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
    make_same_rpc_calls(
...
def test_fee_history(eidon-chain_cluster, geth):
    w3: Web3 = eidon-chain_cluster.w3
    eth_rpc = w3.provider
    geth_rpc = geth.w3.provider
...
def test_estimate_gas(eidon-chain_cluster, geth):
...
def test_incomplete_send_transaction(eidon-chain_cluster, geth):
