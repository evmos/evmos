...
# also make sure that you are added to the Evoblock organization on buf
...
buf mod update $EVOPROTO

# then, push the evoblock proto module and documentation 
buf push $EVOPROTO

# two commit addresses should be printed to the command line
# the evoblock documentation will have links to the third party documentation
